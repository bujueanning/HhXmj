  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="${packagePath}/save" name="${objectNameLower}Form" id="${objectNameLower}Form" method="post">
              ...
              <div class="box-footer">
                ...
                <shiro:hasPermission name="${objectName}:save">
