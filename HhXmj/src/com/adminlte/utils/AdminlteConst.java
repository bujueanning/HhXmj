...
public class AdminlteConst {
	...
	public static final String SYSNAME = "AdminLTE";	//系统名称路径
	...
	public static ApplicationContext WebContext = null; //该值会在web容器启动时由WebAppContextListener初始化
	...
	public static final String TEACHER_NORMAL_LEVEL = "1";
	public static final String TEACHER_SCHOOL_MANAGER_LEVEL = "2";
	public static final String YYGL_MANAGER = "3";
