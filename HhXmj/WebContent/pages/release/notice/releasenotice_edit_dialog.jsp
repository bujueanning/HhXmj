...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="content">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
				<form class="form-horizontal" action="release/notice/save" name="releasenoticeDialogForm" id="releasenoticeDialogForm" method="post">
						            ...
						            <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  ...
								                  <div class="col-sm-10">
													  <script id="text" name="text" type="text/plain" style="width:900px;height:500px" >${releaseNotice.text}</script>
								                  </div>
								                </div>
								         </div>
					                </div>
...
function formSubmit(){
	  $.ajax({
			type: "POST",
			url:$('#releasenoticeDialogForm').attr('action'),
			data:$('#releasenoticeDialogForm').serialize(),// 你的formid
			cache: false,
			async: false,
