    ...
    <div class="cont_right" style="width:950px;margin: 0 auto;float: none;">
        <div class="content">
            <div class="cont_left" style="height: 477px;">
                <ul>
                    ...
                    <li><ul>
                        ...
                        <li><h3><a href="release/notice/frontList" class="curr" title="发布方公告">发布方公告</a></h3></li>
            ...
            <div class="cont_right">
                <p class="page_pos">当前位置：<a href="/index.html">首页</a> &gt;
                    <span>发布方公告</span>
                </p>
                            ...
                            <c:choose>
                                <c:when test="${not empty varList}">
                                    <c:forEach items="${varList}" var="var" varStatus="vs">
                                        <li>
                                            <span><fmt:formatDate value="${var.release_notice_createtime}" pattern="yyyy-MM-dd" /></span>
                                            <a href="javascript:void(0)" onclick="release('${var.release_notice_id}')" title=${var.title}  >
                                                    ${var.title}
                                            </a>
                                        </li>
                                    </c:forEach>
