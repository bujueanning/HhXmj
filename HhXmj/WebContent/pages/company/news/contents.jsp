...
<div class="content">
    <div class="cont_right" style="width:950px;margin: 0 auto;float: none;">
        ...
        <div class="information" style="width:950px;margin-bottom: 10px;">
            <!--startprint-->
            <p class="page_title">${companyNewsInfo.title}</p>
            <!--资讯信息主体-->
            <div class="info_cont ptop0" style="width:900px;">
                <span class="titles">时间：<fmt:formatDate value="${companyNewsInfo.company_news_createtime}" pattern="yyyy-MM-dd" /></span>
                <div style="border-bottom:2px solid #F2F2F2;line-height:24px;padding-bottom:40px;text-align:left;text-indent:2em;">
                    ${companyNewsInfo.text}<br>
                </div>
            </div>
            <!--endprint-->
            <!--资讯信息主体end-->
                        ...
                        <c:when test="${not empty varList}">
                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                <li>
                                    ...
                                    <a href="company/news/details?company_news_id=${var.company_news_id}" title="${var.title}">${var.title}</a>
                                    <span class="date"><fmt:formatDate value="${var.company_news_createtime}" pattern="yyyy-MM-dd" /></span>
                                </li>
                            </c:forEach>
                        </c:when>
                    </c:choose>
