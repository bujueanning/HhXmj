    ...
    <div class="cont_right" style="width:950px;margin: 0 auto;float: none;">
        <div class="content">
            <div class="cont_left" style="height: 477px;">
                <ul>
                    <li><h2><img src="pages/sys/kj/img/czftitle.png" style="margin-top: 0;"></h2></li>
                    <li><ul>
                        <li><h3><a href="company/news/frontList" title="公司动态">公司动态</a></h3></li>
                        <li><h3><a href="release/notice/frontList" title="发布方公告">发布方公告</a></h3></li>
                        <li><h3><a href="manage/notice/frontList" class="curr" title="处置方公告">处置方公告</a></h3></li>
                    ...
                    <div class="info_cont">
                        <ul>
                            ...
                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                <li>
                                    <span><fmt:formatDate value="${var.manage_notice_createtime}" pattern="yyyy-MM-dd" /></span>
                                    <a href="javascript:void(0)" onclick="manage('${var.manage_notice_id}')" title=${var.title}>
                                            ${var.title}
                                    </a>
                                </li>
                            </c:forEach>
...
<script type="text/javascript">
    function manage(manage_notice_id) {
        window.open('manage/notice/details?manage_notice_id='+manage_notice_id);
    }
</script>
</body>
</html>
