...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="content">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
				<form class="form-horizontal" action="sys/menu/savetree" name="sysmenuDialogForm" id="sysmenuDialogForm" method="post">
...
function formSubmit(flag){
	  $.ajax({
			type: "POST",
			url:$('#sysmenuDialogForm').attr('action'),
			data:$('#sysmenuDialogForm').serialize(),// 你的formid
			cache: false,
			async: false,
