...
<head>
  ...
  <!-- upload -->
  <link rel="stylesheet" href="plugins/ssi_uploader/css/ssi-uploader.css"/>
  <!-- Theme style -->
...
<!-- upload -->
<script src="plugins/ssi_uploader/js/ssi-uploader.js"></script>
<!-- AdminLTE App -->
...
<script>
		...
		$('#ssi-upload').ssi_uploader({url:url,maxFileSize:6,allowed:['jpg','gif','txt','png','pdf','xlsx']});
</script>
</body>
</html>
