...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="content">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
				<form class="form-horizontal" action="sys/acc/save" name="sysaccDialogForm" id="sysaccDialogForm" method="post">
						            ...
						            <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  <label for="sys_acc_fid" class="col-sm-2 control-label">外键id:</label>
								                  <div class="col-sm-10">
								                    <input name="sys_acc_fid" id="sys_acc_fid" type="text" class="form-control"  placeholder="外键id" title="外键id" value="${sysAcc.sys_acc_fid}">
								                  </div>
								                </div>
								         </div>
					                </div>
						            ...
						            <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  ...
								                  <div class="col-sm-10">
								                    <input name="sys_file_updateuid" id="sys_file_updateuid" type="text" class="form-control"  placeholder="修改人" title="修改人" value="${sysAcc.sys_file_updateuid}">
								                  </div>
								                </div>
								         </div>
					                </div>
						            ...
						            <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  ...
								                  <div class="col-sm-10">
								                    <input name="sys_file_createuid" id="sys_file_createuid" type="text" class="form-control"  placeholder="创建人" title="创建人" value="${sysAcc.sys_file_createuid}">
								                  </div>
								                </div>
								         </div>
					                </div>
...
function formSubmit(){
	  $.ajax({
			type: "POST",
			url:$('#sysaccDialogForm').attr('action'),
			data:$('#sysaccDialogForm').serialize(),// 你的formid
			cache: false,
			async: false,
