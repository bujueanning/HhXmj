...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="content">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
				<form class="form-horizontal" action="sys/dict/savetree" name="sysdictDialogForm" id="sysdictDialogForm" method="post">
...
function formSubmit(flag){
	  $.ajax({
			type: "POST",
			url:$('#sysdictDialogForm').attr('action'),
			data:$('#sysdictDialogForm').serialize(),// 你的formid
			cache: false,
			async: false,
