                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="bond_location" class="col-sm-2 control-label">
                            		...
                            		<c:if test="${sysUser.sys_user_reg_type_d == '-1'}">用户</c:if>所在地:</label>
                            <div class="col-sm-10">
                                <select class="inpt w200" id="bond_site" name="bond_site"
                                        style="float: left;">
                                    <c:if test="${paneltitle == '添加'}"> <option value="">请选择省份</option></c:if>  
                                ...
                                <select class="inpt w200" id="sys_area_id" name="sys_area_id"
                                        style="float: left;">
                                         <c:if test="${paneltitle == '添加'}"> <option value="">请选择城市</option></c:if>  
                                ...
                                <c:if test="${sysUser.sys_user_reg_type_d =='a55c6e261e774082bbd5521130c5c1e6' }"><a id="join">加盟商地区唯一性</a></c:if>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#join").click(function(){
			alert("地区唯一性：当一个地区已经有加盟商时，无法添加第二个加盟商的账户。");
		});
					                ...
					                <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  <label for="sys_user_status_d" class="col-sm-2 control-label">用户状态:</label>
								                  <div class="col-sm-10">
