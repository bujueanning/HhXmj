...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <form class="form-horizontal" action="sys/user/list" name="sysuserListForm" id="sysuserListForm" method="post">
	            ...
	            <!-- form start -->
	              <div class="box-body">
	                <div class="form-group">
	                  ...
	                  <label for="conditionValue" class="col-sm-1 control-label">帐号</label>
	                  <div class="col-sm-3">
	                ...
	                <div class="form-group">
	                  ...
	                  <label for="conditionValue" class="col-sm-1 control-label">用户类型</label>
	                  <div class="col-sm-3">
	              ...
	              <table class="table table-hover">
	                <tr>
	                	   <th style="word-break: keep-all;white-space:nowrap;width: 80px;"><input name='checkAll' id='checkAll' type="checkbox" class="flat-red"></th>
						    ...
						    <th style="word-break: keep-all;white-space:nowrap;width: 80px;">密码</th>
						    <th style="word-break: keep-all;white-space:nowrap;width: 80px;">用户状态</th>
						    <th style="word-break: keep-all;white-space:nowrap;width: 80px;">身份证号</th>
						    <th style="word-break: keep-all;white-space:nowrap;width: 80px;">用户来源</th>
							...
							<c:when test="${not empty varList}">
								<c:forEach items="${varList}" var="var" varStatus="vs">
									<tr>
										    ...
										    <td>${var.sys_user_password}</td>
							                <td>${var.sys_user_status_n}</td>
										    <td>${var.sys_user_card}</td>
							                <td>${var.sys_user_reg_type_n}</td>
											<td>
												<shiro:hasPermission name="sysUser:goedit">
													<a style="cursor:pointer;" title="编辑" onclick="edit('sys/user/goedit?sys_user_id='+'${var.sys_user_id}',800);" class="btn btn-social-icon btn-info btn-xs"><i class="fa fa-edit"></i></a>
												</shiro:hasPermission>
												...
												<a style="cursor:pointer;" title="角色配置" onclick="saveuserrole('sys/user/gouserroleconf?sys_user_id='+'${var.sys_user_id}',400);" class="btn btn-social-icon btn-info btn-xs"><i class="fa fa-asterisk"></i></a>
											</td>
									</tr>
								</c:forEach>
							</c:when>
	            ...
	            <div class="box-footer clearfix">
	            	<div class="pull-left">
	            		<shiro:hasPermission name="sysUser:goadd">
	            			 <a style="cursor:pointer;" title="加盟方新增" onclick="add('sys/user/goadd?sys_user_reg_type_d=a55c6e261e774082bbd5521130c5c1e6',800);" class="btn btn-social-icon btn-info"><i class="fa fa-plus-square"></i></a>
	            		</shiro:hasPermission>
	            		<shiro:hasPermission name="sysUser:goadd">
	            			 <a style="cursor:pointer;" title="发布与处置方新增" onclick="add('sys/user/goadd?sys_user_reg_type_d=-1',800);" class="btn btn-social-icon btn-info"><i class="fa fa-plus-square"></i></a>
	            		</shiro:hasPermission>
