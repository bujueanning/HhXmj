...
<head>
    ...
    <script type="text/javascript" src="js/public_t.js"></script>
			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<div style="padding-top: 100px;text-align:center;height:300px;background-image:url(img/5.jpg);background-size:1400px 300px;background-repeat: no-repeat;background-position-x:center"></div>
					</div>

					<div class="item">
						<div style="padding-top: 100px;color: white;text-align:center;height:300px;background-image:url(img/2.jpg);background-size:1400px 300px;background-repeat: no-repeat;background-position-x:center"></div>

					</div>
					<div class="item">
						<div style="padding-top: 100px;text-align:center;height:300px;background-image:url(img/4.jpg);background-size:1400px 300px;background-repeat: no-repeat;background-position-x:center"></div>

					</div>
					<div class="item">
						<div style="padding-top: 100px;text-align:center;height:300px;background-image:url(img/1.jpg);background-size:1400px 300px;background-repeat: no-repeat;background-position-x:center"></div>
...
<!--轮播图-->
  ...
  <div class="notice">
    ...
    <div class="hots">
        <img src="img/corner_1.png" class="corner corner1" />
        <img src="img/corner_2.png" class="corner corner2" />
        <img src="img/corner_3.png" class="corner corner3" />
        <img src="img/corner_4.png" class="corner corner4" />
        <h3>客户盈利是考核的核心指标</h3>投资之道<br />
        <div class="div">
            <div class="fl hots_l">
                <img src="img/11.jpg" width="141" height="105" />
            </div>
            <div class="fr hots_r">
                <p>勤练内功，赢在长期</p>
                <a href="contact.jsp"   class="a">查看详情</a>
            </div>
        </div>
    </div>
    <div class="hots">
        ...
        <div class="div">
            <div class="fl hots_l">
                <img src="img/12.jpg" width="141" height="105" />
            </div>
            <div class="fr hots_r">
    ...
    <div class="hots hots_last">
        ...
        <div class="div">
            <div class="fl hots_l">
                <img src="img/13.jpg" width="141" height="105" />
            </div>
            <div class="fr hots_r">
  ...
  <div class="index_gdlc">
     ...
     <div class="index_gdlc_c">
        <ul class="ul_qxjj" style="padding-top: 11px;height: 40px;">
            <li class="li_first li_curr" id="li_first">资产委外<img src="img/line_arrow1.png"/></li>
            <li id="li_two">资产拍卖<img src="img/line_arrow1.png"/></li>
        </ul>
        <!--债券处置-->
        ...
        <div class="banner1">
			...
			<!-- Indicators -->
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<div style="padding-top: 100px;text-align:center;height:300px;background-image:url(img/21.jpg);background-size:1000px 180px"></div>
					</div>

					<div class="item">
						<div style="padding-top: 100px;color: white;text-align:center;height:300px;background-image:url(img/2.jpg);background-size:1000px 180px"></div>
...
<div class="index_news1 news">
    ...
    <h3 class="h3_1">
        ...
        <a href=""><img src="img/icon_more.png" class="fr img_more" /></a>
    </h3>
