		    ...
		    '<div class="nav_c">'+
		        '<ul id="ull" class="ul">'+
		            '<li class="li li_first">'+
		                '<a href="index.jsp" class="span">首页</a>'+
		            '</li>'+
				    '<li class="li">'+
...
var top='<div class="top_wrap">'+	
		    '<div class="top">'+
		        '<a href="pages/sys/kj/index.jsp">'+
		        	'<img src="img/logo9.png"  class="fl logo"/>'+
		        '</a>'+
		        '<img src="img/tel1.jpg" alt="" class="fl tel" />'+
		        '<div class="fl links">'+
...
var top1 =  '<div class="top_wrap">'+
			'<div class="top">'+
			    '<a href="pages/sys/kj/index.jsp"><img src="img/logo9.png"  class="fl logo"/></a>'+
			    '<img src="img/tel1.jpg" alt="" class="fl tel"/>'+
			    '<div class="fl links">'+
				    '<span class="hidden-xs">'+user_type+name+'已登陆</span><br/>'+
