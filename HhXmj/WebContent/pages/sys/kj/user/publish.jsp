...
<div class="w1000 bc mt10">
	<form action="auction/assets/save" method="post" enctype="multipart/form-data" onsubmit="return check()">
		...
		<div class="mt10">		 
         <table class="table-c-1" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="tdStyle" >
					<input id="auction_project_name" name="auction_project_name"  required/>
				</td>
			...
			<tr>
			 ...
			 <tr>
				 ...
				 <td class="tdStyle">
					 <input id="auction_bail" name="auction_bail" pattern="^[0-9]+(.[0-9]{1,3})?$" maxlength="10" required />
				 </td>
				 <th class="thStyle">起拍价(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_starting_price" name="auction_starting_price" maxlength="8" pattern="^[0-9]+(.[0-9]{1,3})?$" required/>
				 </td>
			 </tr>
			<tr>
				...
				<td class="tdStyle">
					<input id="auction_transaction_type" name="auction_transaction_type"  required/>
				</td>
		     </tr>
			 <tr>
				 <th class="thStyle">挂牌开始时间</th>
				 <td class="tdStyle">
					 <input  name="auction_listing_start_time" id="auction_listing_start_time"  type="text" class="form-control datepicker"  value="<fmt:formatDate value="${sysGoods.sys_goods_stime}" pattern="yyyy-MM-dd HH:mm:ss" />">
				 </td>
				 <th class="thStyle">
					 挂牌结束时间
				 </th>
				 <td class="tdStyle">
					 <input  name="auction_listing_end_time" id="auction_listing_end_time"  type="text" class="form-control datepicker"  value="<fmt:formatDate value="${sysGoods.sys_goods_stime}" pattern="yyyy-MM-dd HH:mm:ss" />">
				 </td>
			 </tr>
		     <tr>
				<th class="thStyle">标的资产名称</th>
				<td class="tdStyle">	
					 <input id="auction_target_asset_name" name="auction_target_asset_name"  required />
				</td>
				<th class="thStyle">标的企业性质</th>
				<td class="tdStyle">		
				  	<input id="auction_target_enterprise_nature" name="auction_target_enterprise_nature" required />
				</td>
		     </tr>
			 <tr>
				 <th class="thStyle">所属行业</th>
				 <td class="tdStyle">
					 <input id="auction_industry" name="auction_industry" required  />
				 </td>
				 <th class="thStyle">出具法律意见书的律师机构</th>
				 <td class="tdStyle">
					 <input id="auction_law_firm" name="auction_law_firm" required />
				 </td>
			 </tr>
			 <tr>
				 <th class="thStyle">债权本金(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_creditor_capital" name="auction_creditor_capital"  maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
				 <th class="thStyle">其中保证本金(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_pledge_capital" name="auction_pledge_capital" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required  />
				 </td>
			 </tr>
			 <tr>
				 <th class="thStyle">其中抵押本金(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_mortgage_capital" name="auction_mortgage_capital" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
				 <th class="thStyle">其中质押本金(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_impawn_capital" name="auction_impawn_capital" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
			 </tr>
			 <tr>
				 <th class="thStyle">债权利息(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_creditor_interest" name="auction_creditor_interest" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
				 <th class="thStyle">债权孳生息(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_creditor_yield" name="auction_creditor_yield" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
			 </tr>
			 <tr>
				 <th class="thStyle">物权(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_real_right" name="auction_real_right" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
				 <th class="thStyle">股权(万元)</th>
				 <td class="tdStyle">
					 <input id="auction_stock_right" name="auction_stock_right" maxlength="10" pattern="^[0-9]+(.[0-9]{1,3})?$" required />
				 </td>
			 </tr>
		     <tr>
				...
				<td width="150" style="border-width:1px;" colspan="3">
				   	<textarea required id="auction_major_issues" name="auction_major_issues" style="width:100%;" rows="7"></textarea>
				</td>
			</tr>
			<tr>
				<th class="thStyle">联系人</th>
				<td class="tdStyle">	
					<input id="auction_contacts" name="auction_contacts" required />
				</td>
				<th class="thStyle">联系方式</th>
				<td class="tdStyle">		
				    <input id="auction_contact_number" name="auction_contact_number" required />
				</td>
		     </tr>
			 <tr>
				 <th class="thStyle">项目公告</th>
				 <td width="80%" style="border-width:1px;" colspan="3" >
				 	<script id="auction_project_announcement" name="auction_project_announcement" type="text/plain" ></script>
				 </td>
			 </tr>
		      <tr>
				<td style="width:130px ; border-width:1px;text-align:center" width="120">
...
<script type="text/javascript">
	function check(){
		if($("#auction_location").val()==""){
			alert("请选择地址！");
			return false;
		}
		var img = $("#auction_assets_img").val();
		if(img == ""){
			alert("请上传图片！");
			return false;
		}
