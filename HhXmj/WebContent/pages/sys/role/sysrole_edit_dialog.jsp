...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    <section class="content">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
				<form class="form-horizontal" action="sys/role/savetree" name="sysroleDialogForm" id="sysroleDialogForm" method="post">
...
function formSubmit(flag){
	  $.ajax({
			type: "POST",
			url:$('#sysroleDialogForm').attr('action'),
			data:$('#sysroleDialogForm').serialize(),// 你的formid
			cache: false,
			async: false,
