  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="sys/buy/save" name="sysbuyForm" id="sysbuyForm" method="post">
              
	              	<input type="hidden" name="sys_buy_id" id="sys_buy_id" value="${sysBuy.sys_buy_id}"/>
	              	<input type="hidden" name="sys_user_id" id="sys_user_id" value="${sysBuy.sys_user_id}"/>
	              	<input type="hidden" name="sys_goods_id" id="sys_goods_id" value="${sysBuy.sys_goods_id}"/>
	              	<input type="hidden" name="sys_buy_createuid" id="sys_buy_createuid" value="${sysBuy.sys_buy_createuid}"/>
	              	<input type="hidden" name="sys_buy_updateuid" id="sys_buy_updateuid" value="${sysBuy.sys_buy_updateuid}"/>
              ...
              <div class="box-body">
					               ...
					               <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
									                <label for="sys_buy_createdate" class="col-sm-2 control-label">创建时间:</label>
									                <div class="col-sm-10">
									                   <div class="input-group date">
								                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
								                  		  <input name="sys_buy_createdate" id="sys_buy_createdate"  type="text" class="form-control datepicker" placeholder="创建时间" title="创建时间" value="<fmt:formatDate value="${sysBuy.sys_buy_createdate}" pattern="yyyy-MM-dd HH:mm:ss" />">
								                	   </div>
					               ...
					               <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
									                <label for="sys_buy_updatedate" class="col-sm-2 control-label">更新时间:</label>
									                <div class="col-sm-10">
									                   <div class="input-group date">
								                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
								                  		  <input name="sys_buy_updatedate" id="sys_buy_updatedate"  type="text" class="form-control datepicker" placeholder="更新时间" title="更新时间" value="<fmt:formatDate value="${sysBuy.sys_buy_updatedate}" pattern="yyyy-MM-dd HH:mm:ss" />">
								                	   </div>
              ...
              <div class="box-footer">
                ...
                <shiro:hasPermission name="sysBuy:save">
...
function formSubmit(){
	  $.ajax({
			type: "POST",
			url:$('#sysbuyForm').attr('action'),
			data:$('#sysbuyForm').serialize(),// 你的formid
			cache: false,
			async: false,
