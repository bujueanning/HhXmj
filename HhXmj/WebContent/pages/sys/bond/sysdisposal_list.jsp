...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" action="sys/bond/list" name="sysbondListForm" id="sysbondListForm"
                          method="post">
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="bond_verify" class="col-sm-2 control-label">状态:</label>
                                    <div class="col-sm-3">
                                    ...
                                    <label for="bond_listing_start_time" class="col-sm-1 control-label">发布时间</label>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-info pull-right" onclick="huihai();"
                                		style="margin-right: 5px;">进入催收系统
                                </button>
                            </div>
                            <!-- /.box-footer -->
                        </div>
            	...
            	<tr>
					 ...
					 <td>${var.bond_case}</td>
						 ...
						 <c:forEach items="${siteList }" var="site" varStatus="vs"> 
								...
								<c:if test="${site.bond_site_id == var.bond_location}">
						 ...
						 <td> <fmt:formatDate value="${var.bond_release_time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						 <c:if test="${var.bond_verify==1}"><td style="color:red;">待审核</td></c:if>
						 <c:if test="${var.bond_verify==2}"><td>已审核</td></c:if>
						 <c:if test="${var.bond_verify==3}"><td style="color:red;">退回</td></c:if>
					
					 <td>
					 									<c:if test="${var.bond_show=='1'}">
                                                      		<a style="cursor:pointer;" title="处理加盟方的接单" 
                                                         		onclick="edit('sys/bond/sheet/gojoinadd?bond_disposal_id='+'${var.bond_disposal_id}',800);"
                                                        ...
                                                        <shiro:hasPermission name="sysGoods:goedit">
                                                            <a style="cursor:pointer;" title="编辑"
                                                               onclick="edit('sys/bond/goedit?bond_disposal_id='+'${var.bond_disposal_id}',800);"
                            ...
                            <div class="box-footer clearfix">
                                <div class="pull-left">
                                    <shiro:hasPermission name="sysGoods:goadd">
                                        <a style="cursor:pointer;" title="新增" onclick="add('sys/bond/goadd',800);"
...
setTimeout(function(){
    ...
    function huihai(){
    	window.location.href="http://192.168.1.160:8080/huihai/myapp/index.html";
    }
