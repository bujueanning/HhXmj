...
<head>
    ...
    <!-- IMGUP 多文件上传插件 -->
    <script src="pages/sys/kj/js/IMGUP/jquery-migrate-1.2.1.min"></script>
    <link  href="pages/sys/kj/js/IMGUP/IMGUP.css">
</head>
...
<section class="content">
    <div class="box box-info">
        ...
        <form class="form-horizontal" action="sys/bond/save" name="sysbondDialogForm" id="sysbondDialogForm"
            ...
            <input type="hidden" name="bond_auditor" id="bond_auditor" value="${currentUser.sys_user_id}"/>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_company_name" id="bond_company_name" type="text"
                                       class="form-control"
                                       placeholder="资产名称" title="资产名称" value="${bondDisposal.bond_company_name}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_asset_number" id="bond_asset_number" type="text"
                                       class="form-control"
                                       placeholder="资产编号" title="资产编号" value="${bondDisposal.bond_asset_number}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="inpt w200" id="bond_deal"
                                        name="bond_deal" style="float: left;" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_case" id="bond_case" type="text"
                                       class="form-control"
                                       placeholder="单笔资产：1份" title="资产包案件数量" value="${bondDisposal.bond_case}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="inpt w200" id="bond_product_solutions"
                                        name="bond_product_solutions" style="float: left;"disabled >
                                    <c:forEach items="${dictList}" var="varMap" varStatus="vs">
		...
		$("#bond_debt_location").change(function(){
			...
			console.log("地址栏："+$("#bond_debt_location").val());
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_disposal_arrears" id="bond_disposal_arrears" type="text"
                                       ...
                                       value="${bondDisposal.bond_disposal_arrears}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_transfer_ratio" id="bond_transfer_ratio" type="text" maxlength="3"
                                       class="form-control" placeholder="佣金比例" title="佣金比例"
                                       value="${bondDisposal.bond_transfer_ratio}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_contact_number" id="bond_contact_number" type="text"
                                       ...
                                       value="${bondDisposal.bond_contact_number}" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_overdue" id="bond_overdue" type="text" 
                                       ...
                                       value="${bondDisposal.bond_overdue}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_deadline" id="bond_deadline" type="text" 
                                       ...
                                       value="${bondDisposal.bond_deadline}" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input name="bond_release_time" id="bond_release_time" type="text" readonly="readonly"
                                           class="form-control" placeholder="发布时间" title="发布时间"
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                        <label for="bond_disposal_img" class="col-sm-2 control-label">加盟方上传信息:</label>
                            <img src="${bondDisposal.bond_disposal_img}">
                            <input type="file" id="bond_disposal_img" name="bond_disposal_img"
                                   value="${bondDisposal.bond_disposal_img}" onchange="">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="bond_show" class="col-sm-2 control-label">加盟方是否接单:</label>
                            <div class="col-sm-10">
                                <select id="bond_show" name="bond_show" class="form-control select2">
                                    <option value="">请选择</option>
                                    <c:forEach items="${dictList}" var="varMap" varStatus="vs">
                                        <c:if test="${varMap.dict_assets_pid == 'bond_show'}">
                                            <option value="${varMap.dict_assets_key}"
                                                    <c:if test="${varMap.dict_assets_key == bondDisposal.bond_show}">selected </c:if>>
                                                    ${varMap.dict_assets_name}
                                            </option>
                                        </c:if>
                                    </c:forEach>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for=bond_verify class="col-sm-2 control-label">委外审核:</label>
                            <div class="col-sm-10">
...
<!-- 多图片上传 -->
<script type="text/javascript" src="pages/sys/kj/js/IMGUP/IMGUP.js"></script>
<!-- /.content -->
<!-- jQuery 2.2.3 -->
