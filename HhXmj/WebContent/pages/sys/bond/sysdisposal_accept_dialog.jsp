...
<section class="content">
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="sys/bond/accept/save" name="sysbondDialogForm" id="sysbondDialogForm"
              method="post" enctype="multipart/form-data">
            <input type="hidden" name="bond_accept_id" id="bond_accept_id" value="${bond_accept_id}"/>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_company_name" id="bond_company_name" type="text"
                                       class="form-control"
                                       placeholder="企业名称" title="企业名称" value="${bondAccept.bond_company_name}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_asset_number" id="bond_asset_number" type="text"
                                       class="form-control"
                                       placeholder="资产编号" title="资产编号" value="${bondAccept.bond_asset_number}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input name="bond_accept_time" id="bond_accept_time" type="text"
                                           ...
                                           value="<fmt:formatDate value="${bondAccept.bond_accept_time}" pattern="yyyy-MM-dd " />">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="bond_asset_number" class="col-sm-2 control-label">报名处置方（公司名）:</label>
                            <div class="col-sm-10">
                                <input name="bond_accept_name" id="bond_accept_name" type="text"
                                       class="form-control"
                                       placeholder="接单处置方" title="接单处置方" value="${bondAccept.bond_accept_name}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_accept_property" id="bond_accept_property" type="text"
                                       ...
                                       value="${bondAccept.bond_accept_property}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_deal_name" id="bond_deal_name" type="text"
                                       ...
                                       value="${bondAccept.bond_deal_name}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_deal_phone" id="bond_deal_phone" type="text"
                                       ...
                                       value="${bondAccept.bond_deal_phone}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_deal_type" id="bond_deal_type" type="text"
                                       ...
                                       value="${bondAccept.bond_deal_type}">
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="bond_choose" class="col-sm-2 control-label">是否完成订单:</label>
                            <div class="col-sm-10">
                                <select class="inpt w200" id="bond_choose"
                                        name="bond_choose" style="float: left;">
                                    <c:forEach items="${dictList}" var="varMap" varStatus="vs">
                                        <c:if test="${varMap.dict_assets_pid == 'bond_choose'}">
                                            <option value="${varMap.dict_assets_key}"
                                                    <c:if test="${varMap.dict_assets_key == bondAccept.bond_choose}">selected </c:if>>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="accept_major_issues" class="col-sm-2 control-label">重要信息:</label>
                            <div class="col-sm-10">
                                <textarea class="textarea" id="auction_major_issues" name="auction_major_issues"
                                          placeholder="重要信息"
                                          style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">${bondAccept.accept_major_issues}</textarea>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <label for="bond_deal_img" class="col-sm-2 control-label">上传图片:</label>
                            <img id="image" width="200px" height="200px" src="${bondAccept.bond_deal_img}">
                            <input type="file" id="bond_deal_img" name="bond_deal_img"
                                   value="${bondAccept.bond_deal_img}" onchange="companyclickfile()">
                        </div>
                    </div>
                </div>
