                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_disposal_arrears" id="bond_disposal_arrears" type="text"
                                       ...
                                       value="${bondDisposal.bond_disposal_arrears}" required/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_transfer_ratio" id="bond_transfer_ratio" type="text" maxlength="3"
                                       ...
                                       value="${bondDisposal.bond_transfer_ratio}" required/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_overdue" id="bond_overdue" type="text" 
                                       ...
                                       value="${bondDisposal.bond_overdue}" required/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="bond_deadline" id="bond_deadline" type="text" 
                                       ...
                                       value="${bondDisposal.bond_deadline}" required/>
                            </div>
                        </div>
                    </div>
                </div>
