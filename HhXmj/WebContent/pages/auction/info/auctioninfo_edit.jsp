  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="auction/info/save" name="auctioninfoForm" id="auctioninfoForm" method="post">
              
	              	<input type="hidden" name="auction_info_id" id="auction_info_id" value="${auctionInfo.auction_info_id}"/>
	              	<input type="hidden" name="biddingCycle" id="biddingCycle" value="${auctionInfo.biddingCycle}"/>
	              	<input type="hidden" name="idCardFrontImg" id="idCardFrontImg" value="${auctionInfo.idCardFrontImg}"/>
              ...
              <div class="box-footer">
                ...
                <shiro:hasPermission name="auctionInfo:save">
...
function formSubmit(){
	  $.ajax({
			type: "POST",
			url:$('#auctioninfoForm').attr('action'),
			data:$('#auctioninfoForm').serialize(),// 你的formid
			cache: false,
			async: false,
