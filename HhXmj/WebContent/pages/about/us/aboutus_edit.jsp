  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="about/us/save" name="aboutusForm" id="aboutusForm" method="post">
              
	              	<input type="hidden" name="about_us_id" id="about_us_id" value="${aboutUs.about_us_id}"/>
	              	<input type="hidden" name="about_us_createuid" id="about_us_createuid" value="${aboutUs.about_us_createuid}"/>
              ...
              <div class="box-body">
						            ...
						            <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
								                  ...
								                  <div class="col-sm-10">
								                    <input name="text" id="text" type="text" class="form-control"  placeholder="正文" title="正文" value="${aboutUs.text}">
								                  </div>
								                </div>
								         </div>
					                </div>
					               ...
					               <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
									                <label for="about_us_createtime" class="col-sm-2 control-label">创建时间:</label>
									                <div class="col-sm-10">
									                   <div class="input-group date">
								                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
								                  		  <input name="about_us_createtime" id="about_us_createtime"  type="text" class="form-control datepicker" placeholder="创建时间" title="创建时间" value="<fmt:formatDate value="${aboutUs.about_us_createtime}" pattern="yyyy-MM-dd HH:mm:ss" />">
								                	   </div>
					               ...
					               <div class="row">
					            		<div class="col-md-8">
								                <div class="form-group">
									                <label for="about_us_updatetime" class="col-sm-2 control-label">更新时间:</label>
									                <div class="col-sm-10">
									                   <div class="input-group date">
								                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
								                  		  <input name="about_us_updatetime" id="about_us_updatetime"  type="text" class="form-control datepicker" placeholder="更新时间" title="更新时间" value="<fmt:formatDate value="${aboutUs.about_us_updatetime}" pattern="yyyy-MM-dd HH:mm:ss" />">
								                	   </div>
              ...
              <div class="box-footer">
                ...
                <shiro:hasPermission name="aboutUs:save">
